<template>
  <div class="wrap">
    <section class="visual">
      <div class="bx_logo">
        <h1 class="logo">다된다</h1>
      </div>
      <swiper ref="swiper" :options="swiperOption" class="sw_visual">
          ...
          <article class="cont">
            <div class="left">
              ...
              <p class="animate__animated" :class="{
                ...
                우리 회사에 적합한 정책자금, 금융상품 <br/>최적의 금융상품 매칭결과 확인부터 신청까지 <br/>모두 다된다!
              </p>
            </div>
            <div class="right">
              <img class="img animate__animated" :class="{
                'animate__delay_1500ms': aniInfo.visual.p == 'true',
          ...
          <article class="cont">
            <div class="left">
              ...
              <p class="animate__animated" :class="{
                ...
                기업분석을 통한 특허가치평가 조회서비스 <br/>특허 매칭결과 확인부터 신청까지  <br/>모두 다된다!
              </p>
            </div>
            <div class="right">
              <img class="img animate__animated" :class="{
                ...
                'animate__fadeInDown': (aniInfo.visual.p == 'true' && $store.state.ui.view=='tablet'),
                'hide':aniInfo.visual.p == 'hide'
              }" :src="$store.state.ui.url+'/img/main/visual2.svg'" alt="메인 비주얼 이미지2">
            </div>
          </article>
        </swiper-slide>
      ...
      <nuxt-link to="/failure" class="btn" style="display: block; width: 300px; margin:15px auto 50px;padding: 10px;font-size: 14px;">사업자번호 실패 페이지 보기 (임시)</nuxt-link>
    </section>
    <section class="area1">
      <div class="inner">
    ...
    <section class="area2">
      <div class="inner colb">
        ...
        <div class="col_img animate__animated" :class="aniInfo.area2 == 'true'?'animate__fadeInRight':'animate__fadeOutRight'">
